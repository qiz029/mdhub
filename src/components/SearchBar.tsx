  ...
  return (
    <form onSubmit={onSubmit} className="relative w-full max-w-sm">
      <input
        ...
        className="w-full rounded-md border border-stone-300 bg-stone-50 px-3 py-1.5 text-sm text-stone-800 placeholder:text-stone-400 focus:outline-none focus:border-stone-400 focus:bg-white"
      />
